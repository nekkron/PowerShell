...
#$Action = New-ScheduledTaskAction -Execute "C:\Windows\SysWOW64\WindowsPowerShell\v1.0\PowerShell.exe" -Argument "Restart-Service -Name 'BMC Client Management Agent'"
# -Argument "C:\PS\StartupScript.ps1"   #Can be used for locally stored PowerShell scripts
