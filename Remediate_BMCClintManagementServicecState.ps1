#=============================================================================================================================
#
# Script Name:     Remediate_BMCClintManagementServicecState.ps1
# Description:     Purpose of this script is to start the BMC Client Management Agent Service" and change its startup type to Automatic
#       Notes:     No variable substitution needed             
#
#=============================================================================================================================

# Define Variables
$svcCur = "BMC Client Management Agent"
